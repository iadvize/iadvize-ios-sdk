Pod::Spec.new do |spec|
  spec.name          = 'iAdvize'
  spec.version       = '1.0.0'
  spec.homepage      = 'https://github.com/iadvize/mobile-ios-sdk-demo-app'
  spec.authors       = { 'Name' => 'sdk-integration@iadvize.com' }
  spec.summary       = 'iAdvize - iOS Conversation SDK'
  spec.source        = { :http => 'https://github.com/iadvize/mobile-ios-sdk-demo-app/tree/master/IAdvizeConversationSDK.framework' }
