Pod::Spec.new do |spec|
  ...
  spec.ios.vendored_frameworks  = 'IAdvizeConversationSDK.xcframework', 'iAdvizeApollo.xcframework', 'iAdvizeJWTDecode.xcframework', 'iAdvizeSwiftGraylog.xcframework', 'iAdvizeSwiftyMarkdown.xcframework'
