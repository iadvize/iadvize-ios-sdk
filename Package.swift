...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "IAdvizeConversationSDK",
            url: "https://github.com/iadvize/iadvize-ios-sdk/releases/download/2.14.0/IAdvizeSDK.zip",
            checksum: "d61c745e041aee08df2f88337d5f0464be37bcac5e75f22b5eb80080745972d9"
        ),
        .binaryTarget(
            name: "TwilioVideo",
