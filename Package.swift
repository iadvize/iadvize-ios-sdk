...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "IAdvizeConversationSDK",
            url: "https://github.com/iadvize/iadvize-ios-sdk/releases/download/2.13.1/IAdvizeSDK.zip",
            checksum: "f8bcea35ba524ce25bb2a0ca148f27d5332d4ba7c530a3d868f7616615bc73b3"
        ),
        .binaryTarget(
            name: "TwilioVideo",
