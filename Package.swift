...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "IAdvizeConversationSDK",
            url: "https://github.com/iadvize/iadvize-ios-sdk/releases/download/2.15.5/IAdvizeSDK.zip",
            checksum: "f8665217c085827b9f56888b89c001a762d4003f03070f359d63939698d498bc"
        ),
        .binaryTarget(
            name: "TwilioVideo",
