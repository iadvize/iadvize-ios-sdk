# iAdvize iOS SDK support

iAdvize iOS SDK support comes in several distinct status:
...
| Version  | Type                        | Status          |
| -------- | --------------------------- | --------------- |
| `2.18.x` | Latest release              | Full support    |
| `2.17.x` | Current MAJOR, last 3 MINOR | Partial support |
| `2.16.x` | Current MAJOR, last 3 MINOR | Partial support |
